...
<html lang="en">
    ...
    <body id="page-top">
        ...
        <nav class="navbar navbar-expand-lg bg-secondary text-uppercase fixed-top" id="mainNav">
            <div class="container">
                <a class="navbar-brand js-scroll-trigger" href="#page-top">SMAN 1 JAMPANG KULON</a>
        ...
        <header class="masthead bg-primary text-white text-center">
            <div class="container d-flex align-items-center flex-column">
                ...
                <!-- Masthead Subheading-->
                <p class="masthead-subheading font-weight-light mb-0">SMAN1 JAMPANG KULONL</p>
            </div>
        </header>
        <!-- Portfolio Section-->
            ...
            <div class="container">
                <div class="row">
                    ...
                    <div class="col-lg-4">
                        ...
                        <p class="lead mb-0">
                          Jl. Warung Tagog No.1, Nagraksari, Jampang Kulon, Sukabumi Regency, Jawa Barat 43178
                        </p>
                    </div>
                </div>
            </div>
        ...
        <div class="copyright py-4 text-center text-white">
            <div class="container"><small>PPDB ONLINE SMAN1 JAMPANG KULON</small></div>
        </div>
